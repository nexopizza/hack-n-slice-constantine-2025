...
class DatabaseSeeder:
    ...
    def create_users(self):
        ...
        # Regular users with Algerian names
        users_data = [
            {
                'username': 'karim_dz', 'email': 'karim@example.dz', 'first_name': 'Karim', 
                'last_name': 'Bensaïd', 'phone': '+213551234568', 'address': '456 Rue Hassiba Ben Bouali',
                'city': 'Alger', 'nexo_coins': 250, 'xp': 1200, 'level': 3,
                'prefs': {"cuisine": ["Italienne"], "diet": "Aucun", "favorites": []}
            },
            {
                'username': 'amina_dz', 'email': 'amina@example.dz', 'first_name': 'Amina', 
                'last_name': 'Zerrouki', 'phone': '+213551234569', 'address': '789 Avenue des Frères Oudek',
                'city': 'Oran', 'nexo_coins': 500, 'xp': 800, 'level': 2,
                'prefs': {"cuisine": ["Végétarienne"], "diet": "Végétarien", "favorites": []}
            },
            {
                'username': 'yacine_dz', 'email': 'yacine@example.dz', 'first_name': 'Yacine', 
                'last_name': 'Kadri', 'phone': '+213551234570', 'address': '321 Rue Abane Ramdane',
                'city': 'Constantine', 'nexo_coins': 150, 'xp': 300, 'level': 1,
                'prefs': {"cuisine": ["Italienne", "Algérienne"], "diet": "Aucun", "favorites": []}
            }
        ]
